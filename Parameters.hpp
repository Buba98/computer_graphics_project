...
// Controller settings
enum SCREEN {INITIAL_SCREEN, GAME_SCREEN, GAME_OVER_ANIMATION, GAME_OVER_SCREEN};
...
enum DAY_TIME {DAY, SUNSET, NIGHT};
#define GUARD_RAIL_WIDTH 0.17f
#define ONE_POINT_SCORE_DISTANCE 100
#define NUM_TOT_STREETLIGHTS (2 * NUM_LIGHTS_PER_LINE)
#define NUM_TOT_TREES (4 * NUM_TREE_PER_LINE)
#define NUM_TOT_RAILS (2 * NUM_RAIL_PER_LINE)
