...
void GameLogic(Assignment07 *A, float Ar, glm::mat4 &ViewPrj, glm::mat4 &World) {
    ...
    glm::mat4 T = glm::translate(glm::mat4(1), glm::vec3(0, camHeight, camDist));
    glm::mat4 V = glm::lookAt(glm::vec3(T * glm::vec4(Pos, 1)),Pos , glm::vec3(0, 1, 0));
    //translate position Pos with translation T
