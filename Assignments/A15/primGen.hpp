                                 ...
                                 std::vector<uint32_t> &vIdx)
{
    ...
    const glm::vec3 scale_factor = {scaled_box_width / 2, scaled_box_height / 2, scaled_box_depth / 2};
    ...
    const glm::vec2 UVs[6][4] = {
        ...
        // Front
        {
            {box_depth / texture_width, (box_depth + box_height) / texture_height},               // 1
            {box_depth / texture_width, box_depth / texture_height},                              // 3
            {(box_depth + box_width) / texture_width, (box_depth + box_height) / texture_height}, // 2
            {(box_depth + box_width) / texture_width, box_depth / texture_height},                // 4
        },
    };
